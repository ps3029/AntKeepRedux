/obj/item/ramrod
	name = "ramrod"
	icon = 'icons/roguetown/items/arquebus_items.dmi'
...
/obj/item/gun/ballistic/firearm/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	...
	..()
	spawn (1)
		new/obj/effect/particle_effect/smoke/chem(get_ranged_target_turf(user, user.dir, 1))
	spawn (2)
		new/obj/effect/particle_effect/smoke/chem(get_ranged_target_turf(user, user.dir, 2))
	spawn (3)
		new/obj/effect/particle_effect/smoke/chem(get_ranged_target_turf(user, user.dir, 1))
