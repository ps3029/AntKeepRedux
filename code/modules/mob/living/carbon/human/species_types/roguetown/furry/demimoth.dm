/mob/living/carbon/human/species/demimoth
	race = /datum/species/demimoth

/datum/species/demimoth
	name = "Moth"
	id = "demimoth"
	desc = "<b>Moths</b><br>\
	Terrible creatures of the north. Of bad humour and repugnant odor, they shed their scales like dandruff, caking the way in irritating dust.\
	Fragile night-creatures of ill omen, they are best left to solitary pursuits. Weaving, cooking and farming.\
	Traders covet their silk, and wherever weaves and fabric are concerned, their craftsmothship is of the highest quality.\
	With fragile limbs and vestigial wings, they suffer highly in combat. Most moths have short lifespans, and suffer from joint and vision impairments from a young age.\
	<br>\
	(+2 luck, +1 Intelligence, -1 Strength, -2 Endurance)"
	default_color = "444"
